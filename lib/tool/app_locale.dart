...
class AppLocale
{
	...
	static const Map<String, Map<String, String>> _localizedValues =
	{
		"en": {
			...
			"all_events_title": "Load all events",
			"all_events_info": "Show all events, including all past ones",
		...
		"sv": {
			...
			"all_events_title": "Ladda alla händelser",
			"all_events_info": "Visa alla händelser, inklusive alla tidigare",
			"title_account": "Konto",
